...
$(BUILD_F)$(SRC_F)deposit.o : $(SRC_F)deposit.o 
	$(CC) $(CFLAGS) -c $(SRC_F)deposit.c -o $(BUILD_F)$(SRC_F)deposit.o

$(BUILD_F)$(SRC_F)main.o : $(SRC_F)main.o
...
test: tests.o
	$(CC) $(CFLAGS) $(BUILD_F)test/tests.o -o $(BIN_F)tests

tests.o:
	$(CC) $(CFLAGS) -c $(TEST_F)main.c -o $(BUILD_F)test/tests.o
